SFU Galleries Digital Strategy, 2024 - plain text readme


Style notes

This readme uses markdown "reference style" links for readability, where reference links are enclosed in brackets [ ] instead of parentheses ( ). For headings, programmatic identification is used, where two blank lines precede and one blank line succeeds them.
...
Explore the report:
[Project-Link](https://github.com/sfu-galleries/digital-accessibility-strategic-plan/blob/main/index.html">
...
[Creative-Commons-License](https://creativecommons.org/licenses/by-nc/4.0/?ref=chooser-v1)
...
This work could not have been possible without the work, vision, flexibility, and project management of Russell Gordon. A special thank you to project intern and SFU Galleries Engagement Assistant Chris Outten for his work in interviewing community members and implementing feedback from the report. Thank you to the SFU Galleries team for pursuing this project and being open to interviews and conversations around digital futures and access.

This project was funded by the ___________ and the ________ grants. We are grateful for their generosity.